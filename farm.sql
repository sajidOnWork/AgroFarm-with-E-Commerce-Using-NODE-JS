...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2020 at 09:47 PM
...
(1, 'abid', '12/03/2020', 'Not Approved'),
(2, 'sharif', '10/03/2020', 'Pending'),
(3, 'sajid', '11/03/2020', 'Approved'),
(4, 'ripon', '12/03/2020', 'Cancelled'),
(5, 'xyz', '10/03/2020', 'Pending');
...
(22, 'Jackfruit', 'Jackfruit.jpg', 2, 140, 1),
(18, 'Apple', 'apple.jpg', 3, 360, 105),
...
(101, 'adsa', 'asdasdas@gmail.com', '1654464', 'a', 'asdasda', 'customer', ''),
...
(7, 'Potato', 25, 'Vegetable', 20, 30, 'potato1.jpg', 'Fresh potato', 'potato2.jpg', 'potato.jpg'),
...
(40, 'dddddddddddd', 67, 'Vegetable', 67, 67, '1.jpg', 'Very Good', '2.jpg', '1small_logo.png'),
(42, 'ssssssssssssssssssss', 12, 'Vegetable', 34, 34, 'apple.jpg', 'asdas', 'apple3.jpg', 'apple1.jpg');
...
(31, 1, 'saaa', 's@gmail.com', '01745', 'Mirpur', 3, 'Potato', 2, 132, 'Approved'),
(32, 1, 'saaa', 's@gmail.com', '01745', 'Kuril dhaka', 7, 'Gerlic', 1, 245, 'Approved'),
(33, 1, 'saaa', 's@gmail.com', '01745', 'Kuril', 7, 'Gerlic', 1, 245, 'Pending'),
(34, 1, 'saaa', 's@gmail.com', '01745', 'Kuril', 7, 'Potato', 2, 132, 'Approved'),
(65, 106, 'Sharif', 'o@gmail.com', '5666', 'iljhlhllh cc', 30, 'Aman Rice', 7, 420, 'Pending'),
(66, 106, 'Sharif', 'o@gmail.com', '5666', 'iljhlhllh ', 20, 'Cherry', 20, 12000, 'Pending'),
(67, 106, 'Sharif', 'o@gmail.com', '5666', 'iljhlhllh ', 7, 'Potato', 10, 300, 'Approved'),
(68, 106, 'Sharif', 'o@gmail.com', '5666', 'iljhlhllh ', 30, 'Aman Rice', 1, 60, 'Pending');
...
(61, 'dddddddddddd Production', 'debit', 4489, 'Production Expense', '2020-03-08'),
...
(68, 'sssssssssssssssssssssssssssssssss Production', 'debit', 408, 'Production Expense', '2020-03-10'),
...
(1, 'Owner', '01869302597', 'owner@gmail.com', 'Kuril', '$2b$10$UfONyetNrh5IwIdLB/8erOdlLCx9XkUgv.7/72OwsQMDPgL4mfLS.', 'Owner', 'user11.jpg'),
(2, 'Manager', '01845652165', 'manager@gmail.com', 'Bashundhara', '$2b$10$YZpHxjFR7HiCA0JOUCneWO4FP4ZsytPkG3iZ.Q4eaIAgdAQBSs4/6', 'Manager', 'user11.jpg'),
...
--
ALTER TABLE `customer`
  MODIFY `Cus_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `food`
  MODIFY `Fid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `transaction`
  MODIFY `TRid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
